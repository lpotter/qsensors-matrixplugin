...
#include "matrixrotationsensor.h"
#include "matrixsensorbase.h"
#include <QDebug>

char const * const MatrixRotationSensor::id("matrix.rotation");

MatrixRotationSensor::MatrixRotationSensor(QSensor *sensor)
    : MatrixSensorBase(sensor)
{
    sensorFlag = MatrixSensorBase::Rotation;
...
void MatrixRotationSensor::rotationChanged(const QRotationReading &value)
{
